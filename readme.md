## Summary
Provide an example of an Apple cross-platform, collaborative RealityKit app by using Tic-Tac-Toe as example. There are 2 gameboards, a 2-dimensional 3x3 and a 3 dimensional 4x4x4. The game modes supported are against a bot (easy, mediaum or hard level) and a remote opponent using SharePlay.
